...
# Association table for many-to-many relationship between employees and meetings
...
class Employee(db.Model):
    ...
    # Relationship mapping the employee to meetings
    meetings = db.relationship(
        'Meeting', secondary=employee_meetings, back_populates='employees')

    # Relationship mapping the employee to assignments
...
class Meeting(db.Model):
    ...
    # Relationship mapping the meeting to employees
...
class Project(db.Model):
    ...
    # Relationship mapping project to assignments
    assignments = db.relationship(
...
# Association model for employee-project relationship with extra attributes
